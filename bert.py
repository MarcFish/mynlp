...
def get_bert(vocab_size, num_layers=4, d_model=256, num_heads=8, dff=512, dropout_prob=0.1):
...
dff = d_model * 4
num_heads = 8
model = get_bert(VOCAB_SIZE, num_layers=num_layers, d_model=d_model, dff=dff, num_heads=num_heads)
model.summary()
